                                       ...
                                       <fieldset>
                                          <div class="account-profile d-flex align-items-center mb-4 ">
                                             <div class="row">
                                                ...
                                                <div class="circle">
                                                   <img class="profile-pic" src="<?php echo $row["profile_img"];?>">
                                          ...
                                          <div class="edit-profile__body personal_info">
                                                ...
                                                <div class="form-group mb-25">
                                                    <input type="text" class="form-control" id="user_id" name="user_id" value="<?php echo $row["id"];?>" style="display:none;">
                                                   <label for="fname">name</label>
                                                   <input type="text" class="form-control" id="fname" name="fname" value="<?php echo $row["name"];?>" placeholder="Duran Clayton" required>
                                                </div>
                                                <!-- <div class="form-group mb-25">
                                                ...
                                                <div class="form-group mb-25">
                                                   ...
                                                   <input type="email" class="form-control" name="email" id="email" value="<?php echo $row["email"];?>" placeholder="sample@email.com" required>
                                                </div>
                                                <div class="form-group mb-25">
                                                   <label for="phoneNumber5">phone number</label>
                                                   <input type="tel" class="form-control" id="phoneNumber5" name="mobile" value="<?php echo $row["mobile"];?>" placeholder="+440 2546 5236" required>
                                                </div>
                                                <div class="form-group mb-25 status-radio">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="radio-theme-default custom-radio ">
                                                            ...
                                                            <input class="radio" type="radio" name="status"  <?php echo ($row["user_status"]=="Active") ? 'checked' : ''; ?> id="radio-hl1">
                                                            <label for="radio-hl1">
                                                                <span class="radio-text">Activated</span>
                                                            </label>
                                                        </div>

                                                        <div class="radio-theme-default custom-radio ">
                                                            <input class="radio" type="radio" name="status" <?php echo ($row["user_status"]=="Deactive") ? 'checked' : ''; ?> id="radio-hl2">
                                                            <label for="radio-hl2">
                                                        ...
                                                        <div class="radio-theme-default custom-radio ">
                                                            <input class="radio" type="radio" name="status" <?php echo ($row["user_status"]=="Blocked") ? 'checked' : ''; ?> id="radio-hl3">
                                                            <label for="radio-hl3">
                                       ...
                                       <div class="edit-profile__body">
                                          <fieldset>
                                             <div class="form-group mb-25">
                                                ...
                                                <input type="text" class="form-control" id="pan_num" value="<?php echo $row["pan_num"];?>" name="pan_num" placeholder="Eg:HAPR4789M" required>
                                             </div>
                                             ...
                                             <div class="form-group mb-25">
                                                ...
                                                <input type="text" class="form-control" id="aadhar_num" name="aadhar_num" value="<?php echo $row["aadhar_num"];?>" placeholder="Eg, 123456789012345" required>
                                             </div>
                                       ...
                                       <div class="edit-profile__body">
                                          <fieldset>
                                             <div class="form-group mb-25">
                                                   ...
                                                   <input type="text" class="form-control" id="account_number" value="<?php echo $row["account_num"];?>" name="account_number" placeholder="Account Number" required>
                                             </div>
                                             <div class="form-group mb-25">
                                                   <label for="ifsc_code">IFSC Code</label>
                                                   <input type="text" class="form-control" id="ifsc_code" name="ifsc_code" value="<?php echo $row["ifsc_code"];?>" placeholder="IFSC Code" required>
                                             </div>
                                             <div>
                                                <div class="form-group mb-25 ba">
                                                      <label for="bank_name">bank name</label>
                                                      <input type="text" class="form-control" id="bank_name" value="<?php echo $row["bank_name"];?>" name="bank_name" placeholder="Bank Name" disabled>
                                                </div>
                                                <div class="form-group mb-25">
                                                      <label for="bank_address">bank address</label>
                                                      <input type="text" class="form-control" id="bank_address" value="<?php echo $row["bank_address"];?>" name="bank_address" placeholder="Bank Address" disabled>
                                                </div>
                                                <div class="row">
                                                   <div class="form-group mb-25 col">
                                                         <label for="branch_name">Branch name</label>
                                                         <input type="text" class="form-control" id="branch_name" value="<?php echo $row["branch_name"];?>" name="branch_name" placeholder="Branch Name" disabled>
                                                   </div>
                                                   <div class="form-group mb-25 col">
                                                         <label for="branch_center">Branch center</label>
                                                         <input type="text" class="form-control" id="branch_center" value="<?php echo $row["branch_center"];?>" name="branch_center" placeholder="Branch Center" disabled>
                                                   </div>
                                                   <div class="form-group mb-25 col">
                                                         <label for="branch_district">Branch District</label>
                                                         <input type="text" class="form-control" id="branch_district" value="<?php echo $row["branch_district"];?>" name="branch_district" placeholder="Branch District" disabled>
                                                   </div>
                                                   <div class="form-group mb-25 col">
                                                         <label for="branch_state">Branch State</label>
                                                         <input type="text" class="form-control" id="branch_state" value="<?php echo $row["branch_state"];?>" name="branch_state" placeholder="Branch State" disabled>
                                                   </div>
                                                </div>
                                             </div>
