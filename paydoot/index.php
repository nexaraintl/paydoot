...
<body>
                     ...
                     <div class="card border-0">
                        <div class="card-header">
                           <div class="edit-profile__title">
                              <h6>Sign in PayDoot Admin</h6>
                           </div>
                        </div>
                        <div class="card-body">
                           <div class="edit-profile__body">
                            
                            <form name="frmUser" id="loginForm" method="POST" action="">
                              ...
                              <div class="admin-condition" style="display:none;">
                              ...
                              <div class="admin__button-group button-group d-flex pt-1 justify-content-md-start justify-content-center">
                                 <input type="submit" name="submit" value="sign in" class="btn btn-primary btn-default w-100 btn-squared text-capitalize lh-normal px-50 signIn-createBtn ">
                              </div>
                            </form>
                           </div>
                        </div><!-- End: .card-body -->
                        <div class="px-20" style="display:none;">
                        ...
                        <div class="admin-topbar" style="display:none">
                           <p class="mb-0">
   ...
   <div class="enable-dark-mode dark-trigger" style="display:none;">
      <ul>
         <li>
            <a href="#">
