    ...
    <section class="banner-section inner-banner product">
        <div class="overlay">
    ...
    <!-- Personalized Solution In start -->
    <section class="personalized-solution">
        <div class="overlay pt-120 pb-120">
            <div class="container wow fadeInUp">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <img src="assets/images/personalized-solution-bg.png" alt="images">
                    </div>
                    <div class="col-lg-6">
                        <div class="section-text">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-6">
                        <div class="section-header text-center">
                            ...
                            <p>Get answers to all questions you have and boost your knowledge so you can save, invest and spend smarter. <a href="faqs.php">See all questions here!</a></p>
                        </div>
                    </div>
                </div>
                <div class="row d-flex justify-content-center">
